...
require 'impose/pdf-ext'
require 'impose/forms/card_fold'
require 'impose/forms/duodecimo'
require 'impose/forms/folio'
require 'impose/forms/quarto'
require 'impose/forms/octavo'
require 'impose/forms/sexto'
require 'impose/forms/sextodecimo'
require 'impose/signature'

module Impose
  class Builder
    PRIMARY_LAYOUTS = {
      'card-fold4' => Impose::Forms::CardFold::Quarto,
      'card-fold8' => Impose::Forms::CardFold::Octavo,
      'folio' => Impose::Forms::Folio,
      'quarto' => Impose::Forms::Quarto,
      'sexto' => Impose::Forms::Sexto,
      'octavo-wide' => Impose::Forms::Octavo::Wide,
      'octavo-tall' => Impose::Forms::Octavo::Tall,
      'duodecimo' => Impose::Forms::Duodecimo::OneCutOutside,
      'duodecimo-i' => Impose::Forms::Duodecimo::OneCutInside,
      'duodecimo-2c' => Impose::Forms::Duodecimo::TwoCut,
      'sextodecimo' => Impose::Forms::Sextodecimo::Nested
    }.freeze
    ...
    ALIASES = {
      ...
      'quarto' => %w( 4to ),
      'sexto' => %w( 6to 6mo ),
      'octavo-wide' => %w( 8vo-wide 8vo octavo ),
      'octavo-tall' => %w( 8vo-tall ),
